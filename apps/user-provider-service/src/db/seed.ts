...
import { categories, platform_settings, provider_categories, specialties } from './schema.js';
  ...
  await db
    ...
    .values([
      ...
      },
      {
        name: 'Nutrition',
        slug: 'nutrition',
        description: 'Nutrition and diet coaching',
        sort_order: 2,
        is_active: true,
      },
      {
      ...
      },
      {
        ...
        description: 'Athletic and sports performance',
        sort_order: 5,
        is_active: true,
      },
      {
        name: 'Rehabilitation',
        slug: 'rehabilitation',
        description: 'Physical rehabilitation and recovery',
        sort_order: 6,
        is_active: true,
      },
    ])
